...
with st.container():
    ...
    with col2:
        ...
        st.write('''These data were taken from the New York Times API, and can be found here: https://www.kaggle.com/datasets/tumanovalexander/nyt-articles-data''')

        st.write('''Data on the murder rate for each year were taken from the FBI database and can be found here: https://ucr.fbi.gov/crime-in-the-u.s/2019/crime-in-the-u.s.-2019/topic-pages/tables/table-1''')
